/*
 * driver/uv/p500uv.c: LG-P500 Undervolting module
 * 
 * Author: doixanh <doixanh at xda-developers>
 * Editer: thachtunganh <thachtunganh@gmail.com>
 *
...
// patch offsets
#ifdef P500
#define DEVICE_NAME				"P500"
#define OFS_KALLSYMS_LOOKUP_NAME	0xC00D1528			// kallsyms_lookup_name
#endif
// struct definition
...
// init module
static int __init p500uv_init(void)
{
...
static void __exit p500uv_exit(void)
{
...
module_init(p500uv_init);
module_exit(p500uv_exit);

MODULE_DESCRIPTION("Undervoltage module for LG-P500");
MODULE_LICENSE("GPL");
